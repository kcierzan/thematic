...
class Theme(base.Theme):
    ...
    nvim_core = base.NeovimTheme(
        ...
        CursorLineNr={"fg": teal, "bg": bg_bright, "style": "bold"},
        Define={"fg": purple},
        ...
        TSAttribute={"fg": orange},
        TSBoolean={"fg": green},
        TSCharacter={"fg": green},
        TSConstBuiltin={"fg": blue2, "style": "italic"},
        TSConstant={"fg": orange, "style": "italic"},
        ...
        TSText={"fg": green},
        TSType={"fg": blue1},
        TSTypeBuiltin={"fg": blue1},
        TSVariable={"fg": foreground},
        TSVariableBuiltin={"fg": blue1},
